...
| --- | --- | --- | --- |
| Room blocking / 室内排练 | [Video](room-pov.mp4) | [Video](room-overview.mp4) | [Generator](../scripts/create_calibration_scene.py) |
| Steamship / 蒸汽小船 | [Video](steamship-pov.mp4) | [Video](steamship-overview.mp4) | [Generator](../scripts/create_steamship_scene.py) |
...
Run the normal setup described in [English](../README.md) or [中文](../README.zh-CN.md). Setup creates `examples/calibration_scene.blend` and `examples/steamship_scene.blend`. Start the director desk and choose **室内排练** or **蒸汽小船** from Projects. Create a variation before editing if you want to keep the original model and keys.
