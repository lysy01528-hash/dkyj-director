...
**0.7.0-preview.3 — macOS / Windows public preview.**
...
**Download it from GitHub and run it on your computer.** The repository homepage is the documentation and source distribution; it is not a hosted Blender application.
...
The current application controls and sample scene labels are primarily Chinese. This README and the agent guide provide English onboarding; [the Chinese manual](README.zh-CN.md) includes the detailed control descriptions.
